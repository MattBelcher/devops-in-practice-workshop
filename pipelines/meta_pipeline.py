...
pipeline = configurator\
	...
	.set_git_material(GitMaterial("https://github.com/MattBelcher/devops-in-practice-workshop.git", branch="master", ignore_patterns=set(['pipelines/*']), invert_filter="True"))
